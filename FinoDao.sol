...
contract FinoToken is ERC20Detailed, Ownable {
    ...
    address public liquidityReceiver = 0xB574b42A9DFB69fE20D3B594210452FDf6B1c10b;
    address public treasuryReceiver = 0xDC9da08BA8F6F13866244E5395155a5b28878BB9;
    address public riskFreeValueReceiver = 0x9c95f306ff6c8125d3981E7BAa194a2efd312d90;
    ...
    constructor() ERC20Detailed("FINO DAO", "FINO", uint8(DECIMALS)) {
    ...
    function takeFee(address sender, address recipient, uint256 gonAmount) internal returns (uint256){
        ...
        _transferFrom(address(this), address(0x000000000000000000000000000000000000dEaD), (gonAmount.div(_gonsPerFragment)).mul(burnFee).div(100));
